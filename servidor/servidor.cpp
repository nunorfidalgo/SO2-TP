...
int inicia_naves(TCHAR *argv) {
	int i;
	naves_invasoras = (NAVE *)calloc(NUM_INVASORAS, sizeof(NAVE));
	...
	naves_defensoras = (NAVE *)calloc(NUM_DEFENSORAS, sizeof(NAVE));
...
int _tmain(int argc, TCHAR *argv[]) {
	...
	inicia_naves(argv[0]);
	/*if (cria_array_naves(naves_invasoras, N_INVASORAS) != 0)
